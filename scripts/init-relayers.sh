...
echo '[INFO] Initializing Ki <> Cosmos relayer...'
rly paths generate $KI_CHAIN_ID $COSMOS_CHAIN_ID ki-cosmos --home $RELAYER_HOME
rly tx clients ki-cosmos --home $RELAYER_HOME
sleep 5
rly tx connection ki-cosmos --home $RELAYER_HOME
sleep 5
rly tx link ki-cosmos --home $RELAYER_HOME
...
echo '[INFO] Initializing Cyber <> Cosmos relayer...'
rly paths generate $CYBER_CHAIN_ID $COSMOS_CHAIN_ID cyber-cosmos --home $RELAYER_HOME
rly tx clients cyber-cosmos --home $RELAYER_HOME
sleep 5
rly tx connection cyber-cosmos --home $RELAYER_HOME
sleep 5
rly tx link cyber-cosmos --home $RELAYER_HOME
